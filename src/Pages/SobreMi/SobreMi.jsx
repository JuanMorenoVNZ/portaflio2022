        ...
        <div className="padre">
            ...
            <div className="contenido">
                <div className="contenidoUno">
                    ...
                    <div>
                    <a className='curriculo' href="#"><h4>Descargar cv</h4></a>
                    </div>
                    <div>
                        <img className='instagram' src={instagram} alt="" />
                        <a href="http://demo.harnishdesign.net/html/callum/index-image-parallax.html"> <img className='linkedin' src={linkedin} alt="" /></a>
